<div class="col-sm-12 collapsible before-after" id="media-inner">
  <div class="row">
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="img-wrapper">
        <img class="before-img" src="<?php echo get_bloginfo( 'template_directory' );?>/images/services/dmb-before.png" alt="">
        <img class="after-img" src="<?php echo get_bloginfo( 'template_directory' );?>/images/services/dmb-after.png" alt="">
      </div>
    </div>
  </div>
</div>
